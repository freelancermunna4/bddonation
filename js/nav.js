var all_nav_sibling_toggler = document.querySelectorAll(".nav_sibling_toggler");
...
function errortoltip(msg) {
    return '<aside id="error-tooltip-1023" class="tooltip fade-down-tt" style="">' + msg + '</aside>';
