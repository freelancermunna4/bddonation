            ...
            <div class="table_content_wrapper">
                <?php
                        ...
                        if(isset($_GET['dlt'])&&isset($_GET['id'])){
                            ...
                            $dlt=$db->Query("DELETE FROM `cause` WHERE id=$id");
                            if($dlt){
                    ...
                    <div class="table_sub_parent">
                        <table class="table">
                            <thead>
                                ...
                                <?php 
                                $dt=$db->QueryFetchArrayAll("SELECT * FROM `cause` ORDER BY id ASC");
                                foreach ($dt as $value) { 
                                ?>
                                <tr class="cc">                                   
                                    <td class="p-3 border whitespace-nowrap">
                                        <div class="text-center"><?php echo $value['causename'] ?></div>
                                    </td>
                                    
                                   
                                  
                                    <td class="p-3 border whitespace-nowrap">
                                        <div class="text-center"><?php echo $value['causetitle'] ?></div>
                                    </td>
                                    ...
                                    <td class="p-3 border whitespace-nowrap">
                                        <div class="w-full flex_center gap-1">
                                            ...
                                            <a href="all-area.php?dlt&id=<?php echo $value['id'] ?>">
