            ...
            <div class="table_content_wrapper">
                <?php
                        if(isset($_GET['dlt'])&&isset($_GET['id'])){
                            ...
                            $dlt=$db->Query("DELETE FROM `tools` WHERE id=$id");
                            if($dlt){
                    ...
                    <div class="table_sub_parent">
                        <table class="table">
                            <thead>
                                ...
                                <?php 
                                $dt=$db->QueryFetchArrayAll("SELECT * FROM `tools` ORDER BY id DESC");
                                foreach ($dt as $value) { 
                                ?>
                                <tr class="cc">
                                    <td class="p-3 border whitespace-nowrap">
                                        <div class="text-center"><?php echo $value['id'] ?></div>
                                    </td>
                                    <td class="p-3 border whitespace-nowrap">
                                        <div class="text-center"><?php echo $value['name'] ?></div>
                                    </td>
                                    <td class="p-3 border whitespace-nowrap">
                                        <div class="text-center"><?php echo $value['price'] ?></div>
                                    </td>
                                    <td class="p-3 border whitespace-nowrap">
                                        <div class="w-full flex_center gap-1">
                                            <a href="alltool.php?dlt&id=<?php echo $value['id'] ?>">
