            ...
            <div class="table_content_wrapper">
                <?php
                        if(isset($_GET['dlt'])&&isset($_GET['id'])){
                            ...
                            $dlt=$db->Query("DELETE FROM spend WHERE id=$id");
                            if($dlt){
                    ...
                    <div class="table_sub_parent">
                        <table class="table">
                            <thead>
                                ...
                                <?php 
                                $dt=$db->QueryFetchArrayAll("SELECT * FROM `spend`  ORDER BY id DESC ");
                                foreach ($dt as $value) { 
                                ?>
                                <tr class="cc">
                                    ...
                                    <td class="p-3 border whitespace-nowrap">
                                        ...
                                        <img  class="w-20 rounded-sm" src="<?php echo "../upload/".$value['image']?>" alt="<?php echo $value['name'] ?>">
                                    ...
                                    <td class="p-3 border whitespace-nowrap">
                                        <div class="text-center">
                                        <img  class="w-20 rounded-sm" src="<?php echo "../upload/".$value['memo']?>" alt="<?php echo $value['name'] ?>">
                                    ...
                                    <td class="p-3 border whitespace-nowrap">
                                        <div class="w-full flex_center gap-1">
                                            ...
                                            <a href="allspend.php?dlt&id=<?php echo $value['id'] ?>">
